...
mechanism       = os.path.join(os.path.dirname(__file__), "..", "jetsurf2.0", "jetsurf2.0.yaml") 
...
scaler              = StandardScaler.load(os.path.join(os.path.dirname(__file__), "scaler.npz"))
temperatures        = np.linspace(400.0, 1000.0, num = 5)
pressures           = np.linspace(5.0,   40.0,   num = 5)
phis                = np.linspace(0.5,   2.0,    num = 5)
